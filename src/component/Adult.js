...
const SEO = {
  title: "Professional Public Speaking Training for Adults | Engtern",
  description:
    "Transform your professional communication skills with Engtern's specialized public speaking program for adults. Expert-led training in business communication, presentation skills, and networking.",
  keywords: [
